      ...
      {activeMenu && (
        <>
          <div className='flex items-center justify-between'>
            <Link to="/" onClick={handleCloseSideBar} className="flex items-center gap-3 mt-4 ml-3 text-xl font-extrabold tracking-tight text-orange-600 dark:text-orange-600">
              <SiShopware className='text-3xl' /> <span>SinShu</span> 
            </Link>
