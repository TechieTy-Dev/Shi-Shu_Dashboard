    ...
    <div className='fixed top-0 right-0 w-screen bg-half-transparent nav-item'>
      <div className='float-right h-screen dark:text-gray-200 bg-white dark:[#484B52] w-400'>
        <div className="flex items-center justify-between p-4 ml-4">
          <p className='text-xl text-semibold'> Settings</p>
          <button type="button"
        ...
        <div className='flex-col p-4 ml-4 border-t-1 border-color'>
          <p className='text-lg text-semibold'> Theme Options</p>
          <div className='mt-4'>
        ...
        <div className='flex-col p-4 ml-4 border-t-1 border-color'>
          <p className='text-lg text-semibold'> Theme Colors</p>
          <div className='flex gap-3'> 
          {themeColors.map((item, index) => (
            <TooltipComponent key={index} content={item.name} position="TopCenter">
              <div className='relative flex items-center gap-5 mt-2 cursor-pointer'>
                <button type="button" className='w-10 h-10 rounded-full cursor-pointer' style={{ backgroundColor: item.color}}
